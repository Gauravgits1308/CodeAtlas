    ...
    <Link href="/" className="flex items-center gap-2.5 group">
      <div className="relative flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-8 h-8 transition-transform duration-300 group-hover:scale-105" fill="none">
          ...
          <rect x="2" y="2" width="28" height="28" rx="8" fill="#111827" stroke="url(#nav-logo-grad)" strokeWidth="1.5"/>
          <path d="M10 11L6 16L10 21" stroke="url(#nav-logo-grad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M22 11L26 16L22 21" stroke="url(#nav-logo-grad)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
